...
class ProductUpdate(BaseModel):
    ...
    estimated_unit_cost: Decimal | None = Field(default=None, ge=0, max_digits=12, decimal_places=2)
...
class ProductRead(ProductBase):
    ...
    def unit_margin(self) -> Decimal:
        return quantize_two(self.selling_price - self.estimated_unit_cost)

    @computed_field
    @property
    def margin_percent(self) -> Decimal:
        return quantize_two((self.unit_margin / self.selling_price) * Decimal("100"))
