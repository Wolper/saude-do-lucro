...
O objetivo central é ajudar o pequeno empresário de alimentação a saber se o negócio está saudável, quanto precisa vender para sobreviver e quais decisões aumentam sua lucratividade.
...
1. Implementar apenas o escopo solicitado.
2. Manter a arquitetura simples e modular.
3. Criar ou ajustar testes quando aplicável.
4. Atualizar documentação quando houver alteração relevante.
5. Informar claramente arquivos alterados, comandos de teste, pendências e riscos.
